    ...
    <div class="container">
        <div class="box form-box">
            <div class="text-center">
                <header>Homeowner Register</header>
            </div>
            <div class="container d-flex flex-column login">
                <form action="amosignup.php" method="POST" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="btn btn-dark w-75 mx-auto mt-4 " name="register_homeowner">Register as
                        Homeowner</button>
