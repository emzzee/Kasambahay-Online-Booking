...
<div class="sidebar ">
    <div class="logo_details">
      <div class="logo_name">KASAMBAHAY</div>
      <i class="bx bx-menu" id="btn"></i>
    </div>
    <ul class="nav-list">
  
      <li>
        <a href="../kasambahay/index.php">
      ...
      <li>
        <a href="../kasambahay/kbmessage.php">
      ...
      <li>
        <a href="../kasambahay/kbhistory.php">
      ...
      <li>
        <a href="../kasambahay/kbsettings.php">
          <i class="bx bx-cog"></i>
      ...
      <li class="profile"><a href="../login/logout.php">
        <div class="profile_details">
          ...
          <div class="profile_content">
            ...
            <div class="designation">Kasambahay</div>
          </div>
        </div>
